...
const devProjects = [
    ...
    },
    {
      ...
      description: "An online store to purchase Designer Notebooks and accessories built in ReactJS",
      imgUrl: Booklet,
    ...
    },
    {
      ...
      description: "Built in ReactJS, GameTube is a video library for gaming related stuff.",
      imgUrl: GameTube,
    ...
    {
      title: "Quiz Click",
      description: "A Mini Quiz game built in React for Cartoon show, Movies and Web Series fans",
      imgUrl: QuizClick,
    ...
    },
    {
      ...
      description: "A Component Library for all the components to be used in further projects",
      imgUrl: ComponentLibrary,
      gitSrc: "https://github.com/khushijohri2001/New-GirlifyCoder-Component-Library",
